...
def generate_launch_description():
    ...
    default_params_file = os.path.join(config_dir, 'rtabmap.ini')

    return LaunchDescription([
        DeclareLaunchArgument('cfg',            default_value=default_params_file,   description='To change RTAB-Map\'s parameters, set the path of config file (*.ini) generated by the standalone app.'),
        # 基础参数
